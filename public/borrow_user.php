...
<body>
    ...
    <div>
        <div id="grad" style=" width: auto; height: auto;margin: 15px;border-radius: 7px;padding: 25px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 10px;">
                        ...
                        <div class="table-container">
                            ...
                            <center>
                                ...
                                <div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-5">
                                    ...
                                    <input class="w3-input" required placeholder="ระบุงานที่จะนำไปใช้ทำกิจกรรม" id="activity" type="text" name="activity" style="max-width: 700px; box-shadow: rgba(0.35, 0, 0, 0.35) 0px 5px 10px;">
                                </div>
