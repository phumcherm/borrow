...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="background-color: #dcdad8;">
            <li class="breadcrumb-item active"><a href="a_back.php">ข้อมูลคืนครุภัณฑ์</a></li>
        </ol>
    </nav>

    <div>
        <h2 style="color: #E6581D;font-family: SUT_Bold;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-caret-right" style="font-size:48px"></i>&nbsp;ข้อมูล คืนครุภัณฑ์
        </h2>
    </div>
    <br>
    <center>
